...
document.querySelector('.btn-roll').addEventListener('click', function() {
    ...
    document.getElementById('dice-1').setAttribute('src','dice-' + dice1 + '.png');
    document.getElementById('dice-2').setAttribute('src','dice-' + dice2 + '.png');
...
// update the UI
    ...
    if(scores[active]>=winningScore) {
        ...
        document.querySelector('.player-' + active + '-panel').classList.remove('active');// we hve added 'winner' class and removed 'active' 
